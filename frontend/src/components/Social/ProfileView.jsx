...
import { Grid, Play, Bookmark, User as UserIcon, Settings, ShieldCheck, Plus, Monitor, Lock, Hash, Heart, MessageCircle, Share2, Download } from 'lucide-react';
...
const ProfileView = ({ user, currentUser, posts: parentPosts = [], onOpenCreatePost }) => {
    ...
    // Restoration: Tab Data Fetching (Allows Saved items to work)
    useEffect(() => {
        const fetchTabData = async () => {
            if (activeTab === 'saved') {
                ...
                // For Posts/Reels, use the live posts passed from the parent
    ...
    return (
        <div className="flex-1 max-w-5xl mx-auto py-16 px-6 md:px-12">
            {/* Header / Premium Intro (Refined Boldness) */}
                                ...
                                tabData.map((post, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 bg-emerald-500/20 opacity-0 group-hover:opacity-100 transition-all z-10 flex flex-col items-center justify-center backdrop-blur-sm">
                                            ...
                                            {post.postPassword && (
                                                <div className="flex items-center gap-2 text-amber-400 text-[8px] font-bold uppercase tracking-widest mt-4 bg-black/40 px-3 py-1 rounded-full">
                                ...
                                >
                                    ...
                                    {isOwnProfile && activeTab === 'posts' && (
                                        <button
                                            ...
                                            className="flex items-center gap-3 px-10 py-4 bg-emerald-500 text-black font-bold text-[10px] uppercase tracking-[0.3em] rounded-2xl hover:bg-emerald-400 transition-all shadow-2xl"
                                        >
